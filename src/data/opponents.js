...
export const KNOCKOUT_OPPONENTS = [
  {
    id: 'e1', image: '/images/Opponants/e1.png', defeatedImage: '/images/Opponants/e1d.png', difficulty: 'Easy', tier: 'Easy', label: 'EASY',
  ...
  {
    id: 'e2', image: '/images/Opponants/e2.png', defeatedImage: '/images/Opponants/e2d.png', difficulty: 'Easy', tier: 'Easy', label: 'EASY',
  ...
  {
    id: 'e3', image: '/images/Opponants/e3.png', defeatedImage: '/images/Opponants/e3d.png', difficulty: 'Easy', tier: 'Easy', label: 'EASY',
  ...
  {
    id: 'm1', image: '/images/Opponants/m1.png', defeatedImage: '/images/Opponants/m1d.png', difficulty: 'Medium', tier: 'Medium', label: 'MEDIUM',
  ...
  {
    id: 'm2', image: '/images/Opponants/m2.png', defeatedImage: '/images/Opponants/m2d.png', difficulty: 'Medium', tier: 'Medium', label: 'MEDIUM',
  ...
  {
    id: 'm3', image: '/images/Opponants/m3.png', defeatedImage: '/images/Opponants/m3d.png', difficulty: 'Medium', tier: 'Medium', label: 'MEDIUM',
  ...
  {
    id: 'h1', image: '/images/Opponants/h1.png', defeatedImage: '/images/Opponants/h1d.png', difficulty: 'Hard', tier: 'Hard', label: 'HARD',
  ...
  {
    id: 'h2', image: '/images/Opponants/h2.png', defeatedImage: '/images/Opponants/h2d.png', difficulty: 'Hard', tier: 'Hard', label: 'HARD',
  ...
  {
    id: 'h3', image: '/images/Opponants/h3.png', defeatedImage: '/images/Opponants/h3d.png', difficulty: 'Hard', tier: 'Hard', label: 'HARD',
