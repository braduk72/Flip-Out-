...
export const playerGameApi = {
  ...
  setAvatar: avatarId => request('/api/fo-player-state', { action: 'set-avatar', avatarId }),
  setPlayerTitle: ({ prefixId = null, suffixId = null }) => request('/api/fo-player-state', { action: 'set-player-title', prefixId, suffixId }),
