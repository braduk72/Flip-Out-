export const MATCH3_TOKEN_CROPS = Object.freeze([
  ...
  },
  {
    ...
    review: {
      status: 'approved',
      notes: 'Tight head crop keeps the eye, brow, open mouth and teeth readable at 32 px while excluding scenery, card text and the fossil panel.',
      flags: [],
    },
  },
  {
