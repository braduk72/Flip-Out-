...
- Preview deployment: commit `94674d4` deployed Ready as `dpl_GKMMdVFUern3fgNiV94Fb8vxLd8y`, generated URL `https://flip-1ultpg9ih-chattocal.vercel.app`, target Preview. `https://dev.flipout.gizmogames.uk` returned HTTP 200 with the same ETag `"877c48c9aa19c753994b4f17a64786f2"` and byte-identical HTML SHA-256 `80A7E2157FF7D414F9016E3B599A93621E7069BF754F510B833D8224064E7E10`. Entry bundle `/assets/index-DbS1GjYG.js` contains `1.21.0-rc-match3-polish`; lazy Match-3 bundle `/assets/Match3-CtEHZd6J.js` contains `No more moves`, `Cascade chain` and `hintedTile`.
