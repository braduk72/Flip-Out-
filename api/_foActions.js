...
import { addCardToPersonalAlbum, createPersonalAlbum, removeCardFromPersonalAlbum } from './_personalAlbums.js'
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (body.action === 'remove-personal-album-card') return res.json(await removeCardFromPersonalAlbum(db, { playerId: player.player_id, albumId: body.albumId, itemId: body.itemId, variant: body.variant }))
