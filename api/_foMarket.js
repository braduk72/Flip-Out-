...
import { createListing, expireMarketListings, settleListing } from './_operations.js'
  ...
  try {
    ...
    if (body.action === 'cancel') {
      ...
      try {
        ...
        await applyReward(client, { playerId: player.player_id, transactionId: `market-cancel:${body.listingId}`, source: 'market-return', reward: { itemId: listing.rows[0].item_id, amount: Number(listing.rows[0].quantity) }, skipCapacityCheck: true })
